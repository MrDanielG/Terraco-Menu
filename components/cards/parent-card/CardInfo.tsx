...
const CardInfoTitle = (props: Props) => {
    return (
        <h1
            className="block text-md leading-tight text-black hover:underline sm:w-full"
...
const CardInfo: React.FC<Props> & {
    ...
    return (
        <div onClick={props.onClick} className="p-5 w-full flex flex-col overflow-hidden h-full">
            {props.children}
        </div>
    );
};
